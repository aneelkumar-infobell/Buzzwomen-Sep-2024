...
<Iconify icon="material-symbols:arrow-back-rounded" />
    ...
    <CardContent>
        ...
        {(busData?.final_save==0 || busData?.final_save=="0")  ? <Card> 
                <CardContent>
                    <TableContainer >
                  <Table aria-label="customized table"  >
                    <TableBody>
                      ...
                      setSendData({ ...sendData, sufficient_diesel: e.target.checked })}}/>
                      </TableCell>
                      
                      </TableRow>
                      <TableRow>
                        <TableCell>Tyres Air Condition sds</TableCell>
                        <TableCell>

                          <Checkbox  
                        onChange={(e) => {
                          console.log(e.target.checked,"tyres_air_condition")
                      setSendData({ ...sendData, tyres_air_condition: e.target.checked })}}/>
                      </TableCell>
              ...
              <Card> 
                <CardContent>
                  ...
                  <Table aria-label="customized table"  >
                    <TableBody>
                      <TableRow>
                        <TableCell>Sufficient Diesel dfsdfs</TableCell>
                       <TableCell><Checkbox checked={busData?.sufficient_diesel==1}  disabled={busData?.final_save==1}/></TableCell>
                      ...
                      <TableRow>
                        <TableCell>Fan</TableCell>
                        <TableCell><Checkbox checked={busData?.fan==1}  disabled={busData?.final_save==1}/></TableCell>
                      </TableRow>
                      <TableRow>
                        <TableCell>Tube Lights</TableCell>
