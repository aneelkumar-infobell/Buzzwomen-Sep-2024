...
func RemoveEnrollNagarikaGelathi(w http.ResponseWriter, r *http.Request, DB *sql.DB) {
	...
	updateRemove := "UPDATE training_participants SET nagarikaenrollment = '0' WHERE tb_id = ? AND id = ?"
