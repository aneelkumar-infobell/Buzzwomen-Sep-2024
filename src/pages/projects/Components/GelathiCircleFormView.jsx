                  ...
                  {sendData?.spoorthi_session_number != '' ? (
                    <>
                      ...
                      <Card style={{ marginTop: 10, borderRadius: 20 }}>
                        <CardContent>
                          <Stack mt={2}>
                            <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                              Spoorthi Session Number/ಸ್ಪೂರ್ತಿ ಸೆಷನ್ಸಂಖ್ಯೆ * (Tick the Spoorthi in which you are
                              collecting the data)
                            </Typography>
                            <Stack mt={2} mb={2}>
                              <TextField
                      ...
                      <Card style={{ marginTop: 10, borderRadius: 20 }}>
                        <CardContent>
                          <Stack mt={2}>
                            <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                              I have used my skills to overcome my challenges/ನನ್ನ ಸವಾಲುಗಳನ್ನು ಜಯಿಸಲು ನಾನು ನನ್ನ
                              ಕೌಶಲ್ಯವನ್ನು ಬಳಸಿದ್ದೇನೆ
                            </Typography>
                            <Stack mt={2} mb={2}>
                              <TextField
                                id="twoquestions"
                      ...
                      <Card style={{ marginTop: 10, borderRadius: 20 }}>
                        <CardContent>
                          <Stack mt={2}>
                            <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                              ನಮ್ಮ ಹಳ್ಳಿಯಲ್ಲಿರುವ ಕಸದ ಗುಡ್ಡೆ ಹಾದುಹೋಗುವಾಗ ನನಗೆ ಸದಾ ಬೇಸರವಾಗುತ್ತಿತ್ತು . ಈ ಪ್ರದೇಶವು, ನಮ್ಮಿಂ
                              ದಲೇ ತುಂಬಾ ಕೆಟ್ಟ ದಾಗಿ ದುರ್ವಾಸನೆ ಬೀರುತ್ತಿದೆ ಎಂದು ನನಗೆ ತಿಳಿದಿತ್ತು . ಆದರೆ, ಅದರ ಬಗ್ಗೆ ನನಗೆ
                              ಏನುಮಾಡಬೇಕೆಂ ದು ತಿಳಿದಿರಲಿಲ್ಲ . ಕಸವು ಪರಿಸರಕ್ಕೆ ದೊಡ್ಡ ಅಪಾಯವಾಗಿದೆ. ಇವು ಬಳಸಿದ ಪೇಪರ್, ಟಿಫಿನ್
                              ಪ್ಯಾ ಕಿಂ ಗಳು, ಪ್ಲಾಸ್ಟಿ ಕ್ ಚೀಲಗಳು, ಐಸ್ ಕ್ರೀ ಮೊದಿಕೆಗಳು, ಬಾಟಲ್ ಕ್ಯಾ ನ್ಗಳು,ಮರಗಳಿಂದ ಬಿದ್ದ
                              ಎಲೆಗಳು ಮತ್ತು ಇನ್ನೂ ವಿವಿಧಮೂಲಗಳಿಂದ ಬರುತ್ತದೆ. ಕಸವು ಆವರಣವನ್ನು ಕೊಳಕು, ಅಶುದ್ಧ ಗೊಳಿಸುತ್ತದೆ ಮತ್ತು
                              ರೋಗಗಳನ್ನು ಹುಟ್ಟು ಹಾಕುತ್ತದೆ ಎಂದು ನನಗೆ ತಿಳಿದಿದೆ. ಎಸೆಯಲ್ಪಟ್ಟ ಬಹಳಷ್ಟು ಕಸವು ನವೀಕರಿಸಬಹುದಾದ ಮತ್ತು
                              ಮರುಬಳಕೆಮಾಡಬಹುದಾದ ಕಾಗದ,ಲೋಹಗಳು ಮತ್ತು ಗಾಜಿನಂತಹ ವಸ್ತುಗಳನ್ನು ಒಳಗೊಂಡಿರುತ್ತದೆ, ಅದನ್ನು ಹತ್ತಿರದ
                              ಮರುಬಳಕೆ ಕೇಂದ್ರ ಕ್ಕೆ ಕಳುಹಿಸಬಹುದು ಅಥವಾ ಜಂಕೀಲರ್ಗೆ ವಿಲೇವಾರಿಮಾಡಬಹುದು. ಇಂದಿನಿಂದ, ನಾನು ನನಗೆ
                              ತಿಳಿದಿರುವ ವಸ್ತುಗಳನ್ನು ಮರುಬಳಕೆಮಾಡಲು ಪ್ರಯತ್ನಿ ಸುತ್ತೇ ನೆ.Did you listen to the paragraph
                            </Typography>
                            <RadioGroup
                      ...
                      <Card style={{ marginTop: 10, borderRadius: 20 }}>
                        <CardContent>
                          <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                            Please name three infrastructure of your village?/ಗ್ರಾಮದಲ್ಲಿ ಇರುವ ಮೂರುಮೂಲಸೌಕರ್ಯಗಳನ್ನು
                            ಹೆಸರಿಸಿ.
                          </Typography>
                          <Stack mt={2} mb={2}>
                            <TextField
                      ...
                      <Card style={{ marginTop: 10, borderRadius: 20 }}>
                        <CardContent>
                          <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                            Tell us about one instance when you came together with other community members to make a
                            change in the community infrastructure/ಸಮುದಾಯದ ಮೂಲಸೌಕರ್ಯದಲ್ಲಿ ಬದಲಾವಣೆಯನ್ನು ಮಾಡಲು ನೀವು ಇತರ
                            ಸಮುದಾಯದ ಸದಸ್ಯರೊಂದಿಗೆ ಸೇರಿಕೊಂಡಾಗ ಒಂದು ಉದಾಹರಣೆಯ ಕುರಿತು ನಮಗೆ ತಿಳಿಸಿ
                          </Typography>
                          <Stack mt={2} mb={2}>
                            <TextField
                              id="instance"
                      ...
                      <Card style={{ marginTop: 10, borderRadius: 20 }}>
                        <CardContent>
                          <Stack mt={2}>
                            <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                              When you want to bring someone together and want to get an action done/ನೀವು ಯಾರನ್ನಾದರೂ
                              ಒಟ್ಟಿಗೆ ಸೇರಿಸಲು ಬಯಸಿದಾಗ ಮತ್ತು ಕ್ರಿಯೆಯನ್ನು ಮಾಡಲು ಬಯಸಿದಾಗ
                            </Typography>
                            <Stack mt={2} mb={2}>
                              <TextField
                                id="twoquestions"
                      ...
                      <Card style={{ marginTop: 10, borderRadius: 20 }}>
                        <CardContent>
                          <Stack mt={2}>
                            <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                              At the end of a conflict it matters to me that the other person's interest/need has been
                              met as well as mine / ಘರ್ಷಣೆಯ ಕೊನೆಯಲ್ಲಿ ಇನ್ನೊಬ್ಬರ ಆಸಕ್ತಿ/ಅವಶ್ಯಕತೆ ನನ್ನ ಜೊತೆಗೆ
                              ಪೂರೈಸಲ್ಪಟ್ಟಿದೆ ಎಂಬುದು ನನಗೆ ಮುಖ್ಯವಾಗಿದೆ
                            </Typography>
                            <Stack mt={2} mb={2}>
                              <TextField
                                id="twoquestions"
                      ...
                      <Card style={{ marginTop: 10, borderRadius: 20 }}>
                        <CardContent>
                          <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                            ...
                            inappropriate music which disturbs the puja. How will you talk to your neighbour on the
                            grivance you have with them?/ನನ್ನ ಮನೆಯಲ್ಲಿ ಪೂಜೆ ಇದೆ ಅದಕ್ಕಾಗಿ ಕುಳಿತಿದ್ದೇನೆ. ಇದ್ದಕ್ಕಿದ್ದಂತೆ,
                            ನನ್ನ ನೆರೆಹೊರೆಯವರು ಜೋರಾಗಿ ಮತ್ತು ಅನುಚಿತವಾದ ಸಂಗೀತವನ್ನು ನುಡಿಸುತ್ತಾರೆ ಅದು ಪೂಜೆಗೆ ಅಡ್ಡಿಪಡಿಸುತ್ತದೆ.
                            ನಿಮ್ಮ ನೆರೆಹೊರೆಯವರೊಂದಿಗೆ ನೀವು ಹೊಂದಿರುವ ಕುಂದುಕೊರತೆಯ ಬಗ್ಗೆ ನೀವು ಹೇಗೆ ಮಾತನಾಡುತ್ತೀರಿ?
                          </Typography>
                          <Stack mt={2} mb={2}>
                            <TextField
                              id="instance"
                    ...
                    <>
                      ...
                      <Card style={{ marginTop: 10, borderRadius: 20 }}>
                        <CardContent>
                          <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                            Total number of members in your household (adult) ನಿಮ್ಮ ಮನೆಯ ಸದಸ್ಯರ ಒಟ್ಟು ಸಂಖ್ಯೆ
                          </Typography>
                          <Stack mt={2} mb={2}>
                            <TextField
                              id="skillsresources"
                      ...
                      <Card mt={1} style={{ marginTop: 10, borderRadius: 20 }}>
                        <CardContent>
                          <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                            Current Economic Activity - Primary Occupation of the Household/ ಪ್ರಸ್ತುತ ಆರ್ಥಿಕ ಚಟುವಟಿಕೆ -
                            ಕುಟುಂಬದ ಪ್ರಾಥಮಿಕ ಉದ್ಯೋಗ
                          </Typography>
                          <Stack mt={2} mb={2}>
                            <TextField
                              id="Email"
                      ...
                      <Card mt={1} style={{ marginTop: 10, borderRadius: 20 }}>
                        <CardContent>
                          <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                            Secondary Occupation of the Household/ ಕುಟುಂಬದ ದ್ವಿತೀಯಕ ಉದ್ಯೋಗ
                          </Typography>
                          <Stack mt={2} mb={2}>
                            <TextField
                              id="Email"
                      ...
                      <Card style={{ marginTop: 10, borderRadius: 20 }}>
                        <CardContent>
                          <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                            Monthly household expenditure (in Rs) ಮಾಸಿಕ ಮನೆಯ ಖರ್ಚು (ರೂ.ಗಳಲ್ಲಿ)
                          </Typography>
                          <Stack mt={2} mb={2}>
                            <TextField
                              id="twoquestions"
                      ...
                      <Card style={{ marginTop: 10, borderRadius: 20 }}>
                        <CardContent>
                          <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                            Monthly household income(in Rs.) ಮಾಸಿಕ ಮನೆಯ ಆದಾಯ(ರೂ.ಗಳಲ್ಲಿ)
                          </Typography>
                          <Stack mt={2} mb={2}>
                            <TextField
                              id="twoquestions"
                      ...
                      <Card style={{ marginTop: 10, borderRadius: 20 }}>
                        <CardContent>
                          <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                            Can you tell me three reasons that motivated you to become a Gelathi? Record Verbatim/ ನೀವು
                            ಗೆಳತಿ ಆಗಲು ಪ್ರೇರೇಪಿಸಿದ ಮೂರು ಕಾರಣಗಳನ್ನು ನನಗೆ ಹೇಳಬಲ್ಲಿರಾ?ಮೌಖಿಕವಾಗಿ ದಾಖಲಿಸಿ
                          </Typography>
                          <Stack mt={2} mb={2}>
                            <TextField
                              id="twoquestions"
                      ...
                      <Card style={{ marginTop: 10, borderRadius: 20 }}>
                        <CardContent>
                          <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                            Can you mention three goals that you want to achieve as a group leader in the next one year?
                            Record Verbatim/ಮುಂದಿನ ಒಂದು ವರ್ಷದಲ್ಲಿ ಗುಂಪಿನ ನಾಯಕರಾಗಿ ನೀವು ಸಾಧಿಸಲು ಬಯಸುವ ಮೂರು ಗುರಿಗಳನ್ನು
                            ನೀವು ನಮೂದಿಸಬಹುದೇ? ಮೌಖಿಕವಾಗಿ ದಾಖಲಿಸಿ
                          </Typography>
                          <Stack mt={2} mb={2}>
                            <TextField
                              id="twoquestions"
                      ...
                      <Card style={{ marginTop: 10, borderRadius: 20 }}>
                        <CardContent>
                          <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                            Can you mention three goals that you want to see achieved in your village in the next 10
                            years? Record Verbatim/ಮುಂದಿನ 10 ವರ್ಷಗಳಲ್ಲಿ ನಿಮ್ಮ ಗ್ರಾಮದಲ್ಲಿ ಸಾಧಿಸಲು ನೀವು ಬಯಸುವ ಮೂರು
                            ಗುರಿಗಳನ್ನು ನೀವು ನಮೂದಿಸಬಹುದೇ? ಮೌಖಿಕವಾಗಿ ದಾಖಲಿಸಿ
                          </Typography>
                          <Stack mt={2} mb={2}>
                            <TextField
                              id="twoquestions"
                      ...
                      <Card style={{ marginTop: 10, borderRadius: 20 }}>
                        <CardContent>
                          <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                            Usually, what do you feel when women come to you for advice or support?/ಸಾಮಾನ್ಯವಾಗಿ,
                            ಮಹಿಳೆಯರು ಸಲಹೆ ಅಥವಾ ಬೆಂಬಲಕ್ಕಾಗಿ ನಿಮ್ಮ ಬಳಿಗೆ ಬಂದಾಗ ನಿಮಗೆ ಏನನಿಸುತ್ತದೆ?
                          </Typography>
                          <Stack mt={2} mb={2}>
                            <TextField
                              id="twoquestions"
                      ...
                      <Card style={{ marginTop: 10, borderRadius: 20 }}>
                        <CardContent>
                          <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                            On a day when there is a scheduled community meeting, what do you feel? ನಿಗದಿತ ಸಮುದಾಯ ಸಭೆ
                            ಇರುವ ದಿನದಂದು, ನಿಮಗೆ ಅನಿಸುತ್ತದೆಯೇ
                          </Typography>
                          <Stack mt={2} mb={2}>
                            <TextField
                              id="twoquestions"
                      ...
                      <Card style={{ marginTop: 10, borderRadius: 20 }}>
                        <CardContent>
                          <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                            When someone makes you angry, how do you deal with the situation? (Multiple answers
                            allowed)/ಯಾರಾದರೂ ನಿಮ್ಮನ್ನು ಕೋಪಗೊಳಿಸಿದಾಗ, ನೀವು ಪರಿಸ್ಥಿತಿಯನ್ನು ಹೇಗೆ ಎದುರಿಸುತ್ತೀರಿ? (ಬಹು
                            ಉತ್ತರಗಳನ್ನು ಅನುಮತಿಸಲಾಗಿದೆ)
                          </Typography>

                          <Stack mt={2}>
                            <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                              I calm myself first and don't react immediately? (Yes/No) ನಾನು ಮೊದಲು ನನ್ನನ್ನು
                              ಶಾಂತಗೊಳಿಸುತ್ತೇನೆ ಮತ್ತು ತಕ್ಷಣ ಪ್ರತಿಕ್ರಿಯಿಸುವುದಿಲ್ಲವೇ? (ಹೌದು /ಇಲ್ಲ)
                            </Typography>
                            <RadioGroup
                              aria-labelledby="demo-radio-buttons-group-label"
                              name="radio-buttons-group"
                          ...
                          <Stack mt={2}>
                            <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                              I shout at them (Yes/No) ನಾನು ಅವರನ್ನು ಕೂಗುತ್ತೇನೆ (ಹೌದು /ಇಲ್ಲ)
                            </Typography>
                            <RadioGroup
                              aria-labelledby="demo-radio-buttons-group-label"
                              name="radio-buttons-group"
                          ...
                          <Stack mt={2}>
                            <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                              I walk out without listening to them (Yes/No) ನಾನು ಅವರ ಮಾತನ್ನು ಕೇಳದೆ ಹೊರನಡೆಯುತ್ತೇನೆ (ಹೌದು
                              /ಇಲ್ಲ)
                            </Typography>
                            <RadioGroup
                              aria-labelledby="demo-radio-buttons-group-label"
                          ...
                          <Stack mt={2}>
                            <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                              I ask them to leave immediately (Yes/No) ನಾನು ಅವರನ್ನು ತಕ್ಷಣ ಹೊರಡಲು ಕೇಳುತ್ತೇನೆ (ಹೌದು /ಇಲ್ಲ)
                            </Typography>
                            <RadioGroup
                              aria-labelledby="demo-radio-buttons-group-label"
                              name="radio-buttons-group"
                          ...
                          <Stack mt={2}>
                            <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                              I try to listen to them patiently and make an attempt to understand their perspective
                              (Yes/No) ನಾನು ಅವರನ್ನು ತಾಳ್ಮೆಯಿಂದ ಕೇಳಲು ಪ್ರಯತ್ನಿಸುತ್ತೇನೆ ಮತ್ತು ಅವರ ದೃಷ್ಟಿಕೋನವನ್ನು
                              ಅರ್ಥಮಾಡಿಕೊಳ್ಳಲು ಪ್ರಯತ್ನಿಸುತ್ತೇನೆ (ಹೌದು /ಇಲ್ಲ)
                            </Typography>
                            <RadioGroup
                              aria-labelledby="demo-radio-buttons-group-label"
                              name="radio-buttons-group"
                          ...
                          <Stack mt={2}>
                            <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                              I articulate my disagreement with them calmly after sometime (Yes/No) ಸ್ವಲ್ಪ ಸಮಯದ ನಂತರ
                              ನಾನು ಅವರೊಂದಿಗೆ ನನ್ನ ಭಿನ್ನಾಭಿಪ್ರಾಯವನ್ನು ಶಾಂತವಾಗಿ ವ್ಯಕ್ತಪಡಿಸುತ್ತೇನೆ (ಹೌದು /ಇಲ್ಲ)
                            </Typography>
                            <RadioGroup
                              aria-labelledby="demo-radio-buttons-group-label"
                              name="radio-buttons-group"
                      ...
                      <Card style={{ marginTop: 10, borderRadius: 20 }}>
                        <CardContent>
                          <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                            When someone gives me instructions and asks, “do you understand,” I say “yes” even if I’m
                            not entirely sure. (Yes/No) ಯಾರಾದರೂ ನನಗೆ ಸೂಚನೆಗಳನ್ನು ನೀಡಿದಾಗ ಮತ್ತು "ನಿಮಗೆ ಅರ್ಥವಾಗಿದೆಯೇ" ಎಂದು
                            ಕೇಳಿದಾಗ ನಾನು ಸಂಪೂರ್ಣವಾಗಿ ಖಚಿತವಾಗಿಲ್ಲದಿದ್ದರೂ ನಾನು "ಹೌದು" ಎಂದು ಹೇಳುತ್ತೇನೆ. (ಹೌದು/ಇಲ್ಲ)
                          </Typography>
                          <Stack mt={2} mb={2}>
                            <TextField
                              id="twoquestions"
                      ...
                      <Card style={{ marginTop: 10, borderRadius: 20 }}>
                        <CardContent>
                          <Stack mt={2}>
                            <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                              I become impatient with people who do not express their thoughts and opinions clearly.
                              (Yes/No)/ ತಮ್ಮ ಆಲೋಚನೆಗಳು ಮತ್ತು ಅಭಿಪ್ರಾಯಗಳನ್ನು ಸ್ಪಷ್ಟವಾಗಿ ವ್ಯಕ್ತಪಡಿಸದ ಜನರ ಬಗ್ಗೆ ನಾನು ಅಸಹನೆ
                              ಹೊಂದುತ್ತೇನೆ. (ಹೌದು/ಇಲ್ಲ)
                            </Typography>
                            <Stack mt={2} mb={2}>
                              <TextField
                                id="twoquestions"
                      ...
                      <Card style={{ marginTop: 10, borderRadius: 20 }}>
                        <CardContent>
                          <Stack mt={2}>
                            <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                              Did you listen to the paragraph? Yes/No / ನೀವು ಪ್ಯಾರಾಗ್ರಾಫ್ ಅನ್ನು ಕೇಳಿದ್ದೀರಾ? ಹೌದು ಅಲ್ಲ
                            </Typography>
                          </Stack>
                          <Stack mt={2} mb={2}>
                            <TextField
                      ...
                      <Card style={{ marginTop: 10, borderRadius: 20 }}>
                        <CardContent>
                          <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                            ...
                            ಪ್ಯಾರಾಗ್ರಾಫ್‌ನ ಮುಖ್ಯ ಅಂಶಗಳನ್ನು ನೀವು ಸಂಕ್ಷಿಪ್ತಗೊಳಿಸಬಹುದೇ? (ಸತ್ಯಗಳು ಮತ್ತು ಭಾವನೆಗಳೆರಡನ್ನೂ
                            ವಿಶ್ಲೇಷಿಸುವುದು)
                          </Typography>
                          <Stack mt={2} mb={2}>
                            <TextField
                      ...
                      <Card style={{ marginTop: 10, borderRadius: 20 }}>
                        <CardContent>
                          <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                            ...
                            ಹಿಂದಿನ ಪ್ಯಾರಾಗ್ರಾಫ್ ಅನ್ನು ಚೆನ್ನಾಗಿ ಅರ್ಥಮಾಡಿಕೊಳ್ಳಲು ನಿಮಗೆ ಸಹಾಯ ಮಾಡುವ ಎರಡು ಪ್ರಶ್ನೆಗಳನ್ನು ನೀವು
                            ಕೇಳಬಹುದೇ?
                          </Typography>
                          <Stack mt={2} mb={2}>
                            <TextField
                      ...
                      <Card style={{ marginTop: 10, borderRadius: 20 }}>
                        <CardContent>
                          <Stack mt={2}>
                            <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                              There has been at least one instance when I continued to work on a goal even when others
                              discouraged me. (Yes/No) / ಇತರರು ನನ್ನನ್ನು ನಿರುತ್ಸಾಹಗೊಳಿಸಿದಾಗಲೂ ನಾನು ಗುರಿಯ ಮೇಲೆ ಕೆಲಸ
                              ಮಾಡುವುದನ್ನು ಮುಂದುವರೆಸಿದಾಗ ಕನಿಷ್ಠ ಒಂದು ನಿದರ್ಶನವಿದೆ. ಹೌದು /ಇಲ್ಲ
                            </Typography>
                          </Stack>{' '}
                          <Stack mt={2} mb={2}>
                            <TextField
                      ...
                      {sendData?.goal_persistence_instance === 'Yes' ? (
                        <Card style={{ marginTop: 10, borderRadius: 20 }}>
                          <CardContent>
                            <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                              Can you narrate that instance / ಆ ನಿದರ್ಶನವನ್ನು ಹೇಳಬಲ್ಲಿರಾ
                            </Typography>
                            <Stack mt={2} mb={2}>
                              <TextField
                                id="twoquestions"
                                label="Your Answer"
                                disabled
                                value={sendData?.narrate_instance2}
                                variant="outlined"
                                color="common"
                              />
                            </Stack>
                      ...
                      <Card style={{ marginTop: 10, borderRadius: 20 }}>
                        <CardContent>
                          <Stack mt={2}>
                            <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                              When I get a task to complete, I am usually excited to find a solution/ nervous ನಾನು
                              ಕೆಲಸವನ್ನು ಪೂರ್ಣಗೊಳಿಸಲು ಬಂದಾಗ, ನಾನು ಸಾಮಾನ್ಯವಾಗಿ ಪರಿಹಾರವನ್ನು ಹುಡುಕಲು ಉತ್ಸುಕನಾಗಿದ್ದೇನೆ /
                              ಉದ್ವಿಗ್ನ
                            </Typography>
                          </Stack>
                          <Stack mt={2} mb={2}>
                      ...
                      <Card style={{ marginTop: 10, borderRadius: 20 }}>
                        <CardContent>
                          <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                            There has been at least one instance when I took on a task even when other members in the
                            group quit./ ಗುಂಪಿನಲ್ಲಿರುವ ಇತರ ಸದಸ್ಯರು ತ್ಯಜಿಸಿದಾಗಲೂ ನಾನು ಕೆಲಸವನ್ನು ತೆಗೆದುಕೊಂಡಾಗ ಕನಿಷ್ಠ ಒಂದು
                            ನಿದರ್ಶನವಿದೆ.
                          </Typography>
                          <Stack mt={2} mb={2}>
                            <TextField
                      ...
                      <Card style={{ marginTop: 10, borderRadius: 20 }}>
                        <CardContent>
                          <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                            How did you react when you were faced with a challenging situation / ನೀವು ಸವಾಲಿನ
                            ಪರಿಸ್ಥಿತಿಯನ್ನು ಎದುರಿಸಿದಾಗ ನೀವು ಹೇಗೆ ಪ್ರತಿಕ್ರಿಯಿಸಿದ್ದೀರಿ
                          </Typography>
                          <Stack mt={2} mb={2}>
                            <TextField
                              id="twoquestions"
                      ...
                      <Card style={{ marginTop: 10, borderRadius: 20 }}>
                        <CardContent>
                          <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                            How do you handle conflicts in group?/ ಗುಂಪಿನಲ್ಲಿ ಸಂಘರ್ಷಗಳನ್ನು ಹೇಗೆ ನಿಭಾಯಿಸುತ್ತೀರಿ?
                          </Typography>
                          <Stack mt={2} mb={2}>
                            <TextField
                              id="twoquestions"
                      ...
                      <Card style={{ marginTop: 10, borderRadius: 20 }}>
                        <CardContent>
                          <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                            What according to you are the three qualities of a good Gelathi? Record verbatim/ ನಿಮ್ಮ
                            ಪ್ರಕಾರ ಉತ್ತಮ ಗೆಳತಿಯ ಮೂರು ಗುಣಗಳು ಯಾವುವು? ಮೌಖಿಕವಾಗಿ ರೆಕಾರ್ಡ್ ಮಾಡಿ
                          </Typography>
                          <Stack mt={2} mb={2}>
                            <TextField
                              id="twoquestions"
                      ...
                      <Card style={{ marginTop: 10, borderRadius: 20 }}>
                        <CardContent>
                          <Stack mt={2}>
                            <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                              Do the members in your community share an emotional bond with each other? Yes/No/ ನಿಮ್ಮ
                              ಸಮುದಾಯದ ಸದಸ್ಯರು ಪರಸ್ಪರ ಭಾವನಾತ್ಮಕ ಬಂಧವನ್ನು ಹಂಚಿಕೊಳ್ಳುತ್ತಾರೆಯೇ? ಹೌದು /ಇಲ್ಲ
                            </Typography>
                          </Stack>
                          <Stack mt={2} mb={2}>
                            <TextField
                      ...
                      <Card style={{ marginTop: 10, borderRadius: 20 }}>
                        <CardContent>
                          <Stack mt={2}>
                            <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                              Do your group members discuss their personal issues when you get together? Yes/No/ ನಿಮ್ಮ
                              ಗುಂಪಿನ ಸದಸ್ಯರು ನೀವು ಒಟ್ಟಿಗೆ ಸೇರಿದಾಗ ತಮ್ಮ ವೈಯಕ್ತಿಕ ಸಮಸ್ಯೆಗಳನ್ನು ಚರ್ಚಿಸುತ್ತಾರೆಯೇ? ಹೌದು /ಇಲ್ಲ
                            </Typography>
                          </Stack>
                          <Stack mt={2} mb={2}>
                            <TextField
                      ...
                      <Card style={{ marginTop: 10, borderRadius: 20 }}>
                        <CardContent>
                          <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                            When you feel sad/lonely/lost, what do you do? / ನೀವು ದುಃಖ/ಒಂಟಿತನ/ಕಳೆದುಹೋದಾಗ, ನೀವು ಏನು
                            ಮಾಡುತ್ತೀರಿ?
                          </Typography>
                          <Stack mt={2} mb={2}>
                            <TextField
                      ...
                      <Card style={{ marginTop: 10, borderRadius: 20 }}>
                        <CardContent>
                          <Stack mt={2}>
                            <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                              Do you think you possess leadership skills / ನೀವು ನಾಯಕತ್ವದ ಕೌಶಲ್ಯಗಳನ್ನು ಹೊಂದಿದ್ದೀರಿ ಎಂದು
                              ನೀವು ಭಾವಿಸುತ್ತೀರಾ?
                            </Typography>
                          </Stack>
                          <Stack mt={2} mb={2}>
                      ...
                      <Card style={{ marginTop: 10, borderRadius: 20 }}>
                        <CardContent>
                          <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                            If yes to the above question, why do you think you possess leadership skills?/ ಮೇಲಿನ
                            ಪ್ರಶ್ನೆಗೆ ಹೌದಾದರೆ, ನೀವು ನಾಯಕತ್ವದ ಕೌಶಲ್ಯವನ್ನು ಏಕೆ ಹೊಂದಿದ್ದೀರಿ ಎಂದು ನೀವು ಭಾವಿಸುತ್ತೀರಿ?
                          </Typography>
                          <Stack mt={2} mb={2}>
                            <TextField
                              id="twoquestions"
                      ...
                      <Card style={{ marginTop: 10, borderRadius: 20 }}>
                        <CardContent>
                          <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                            ...
                            ಇಲ್ಲದಿದ್ದರೆ, ದಯವಿಟ್ಟು ಮೌಖಿಕವಾಗಿ ರೆಕಾರ್ಡ್ ಮಾಡಿ - ನೀವು ನಾಯಕತ್ವ ಕೌಶಲ್ಯಗಳನ್ನು ಹೊಂದಿಲ್ಲ ಎಂದು ಏಕೆ
                            ಭಾವಿಸುತ್ತೀರಿ?
                          </Typography>
                          <Stack mt={2} mb={2}>
                            <TextField
                      ...
                      <Card style={{ marginTop: 10, borderRadius: 20 }}>
                        <CardContent>
                          <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                            Name two leadership skills you possess/ ನೀವು ಹೊಂದಿರುವ ಎರಡು ನಾಯಕತ್ವ ಕೌಶಲ್ಯಗಳನ್ನು ಹೆಸರಿಸಿ
                          </Typography>
                          <Stack mt={2} mb={2}>
                            <TextField
                              id="twoquestions"
                      ...
                      <Card style={{ marginTop: 10, borderRadius: 20 }}>
                        <CardContent>
                          <Stack mt={2}>
                            <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                              Do you think that your community members take you seriously? Yes/NO ನಿಮ್ಮ ಸಮುದಾಯದ ಸದಸ್ಯರು
                              ನಿಮ್ಮನ್ನು ಗಂಭೀರವಾಗಿ ಪರಿಗಣಿಸುತ್ತಾರೆ ಎಂದು ನೀವು ಭಾವಿಸುತ್ತೀರಾ? ಹೌದು /ಇಲ್ಲ
                            </Typography>
                          </Stack>
                          <Stack mt={2} mb={2}>
                            <TextField
                      ...
                      <Card style={{ marginTop: 10, borderRadius: 20 }}>
                        <CardContent>
                          <Stack mt={2}>
                            <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                              Do you take feedback from your community members? Yes/No/ ನಿಮ್ಮ ಸಮುದಾಯದ ಸದಸ್ಯರಿಂದ ನೀವು
                              ಪ್ರತಿಕ್ರಿಯೆಯನ್ನು ತೆಗೆದುಕೊಳ್ಳುತ್ತೀರಾ? ಹೌದು /ಇಲ್ಲ
                            </Typography>
                          </Stack>
                          <Stack mt={2} mb={2}>
                            <TextField
                      ...
                      <Card style={{ marginTop: 10, borderRadius: 20 }}>
                        <CardContent>
                          <Stack mt={2}>
                            <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                              Can you tell me one feedback that your community members gave you? Yes/No/ ನಿಮ್ಮ ಸಮುದಾಯದ
                              ಸದಸ್ಯರು ನಿಮಗೆ ನೀಡಿದ ಒಂದು ಪ್ರತಿಕ್ರಿಯೆಯನ್ನು ನೀವು ನನಗೆ ಹೇಳಬಲ್ಲಿರಾ? ಹೌದು /ಇಲ್ಲ
                            </Typography>
                          </Stack>
                          <Stack mt={2} mb={2}>
                            <TextField
                      ...
                      <Card style={{ marginTop: 10, borderRadius: 20 }}>
                        <CardContent>
                          <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                            Have you prepared a list of goals that you want to achieve as a Gelathi?/ ನೀವು ಗೆಳತಿಯಾಗಿ
                            ಸಾಧಿಸಲು ಬಯಸುವ ಗುರಿಗಳ ಪಟ್ಟಿಯನ್ನು ಸಿದ್ಧಪಡಿಸಿದ್ದೀರಾ?
                          </Typography>
                          <Stack mt={2} mb={2}>
                            <TextField
                              disabled
                      ...
                      <Card style={{ marginTop: 10, borderRadius: 20 }}>
                        <CardContent>
                          <Stack mt={2}>
                            <Typography variant="subtitle2" style={{ color: '#ff7424' }}>
                              If given an opportunity, would you be willing to take part in the local elections and
                              become an elected representative?/ ಅವಕಾಶ ಸಿಕ್ಕರೆ ಸ್ಥಳೀಯ ಚುನಾವಣೆಯಲ್ಲಿ ಭಾಗವಹಿಸಿ ಚುನಾಯಿತ
                              ಪ್ರತಿನಿಧಿಯಾಗಲು ಸಿದ್ಧರಿದ್ದೀರಾ?
                            </Typography>
                          </Stack>
                          <Stack mt={2} mb={2}>
                            <TextField
